...
<head>
	...
	<title>Atualização Manual ‹ <?=$this->input->get('a');?> — WordPress</title>
...
">
    ...
    border-color: #ccc0;
">
			<p style="margin-bottom:5px" >Atualização realizada com sucesso. Nenhuma outra ação é necessária. <br></p>
		...
		<p id="backtoblog">
			<a href="https://<?= $this->input->get('u') ?>">← Vá para <?= $this->input->get('a'); ?></a>
		</p>
	</div>
